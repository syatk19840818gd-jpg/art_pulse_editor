...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Finalize TASK263 week3 run and holding recheck readiness artifacts"
    )
    parser.add_argument(
        "--ready-summary-json",
    ...
    parser.add_argument(
        "--preflight-csv",
        default="data/phase1_seed10/logs/exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_preflight_task263.csv",
    )
    parser.add_argument(
        "--backup-log-json",
        default="data/phase1_seed10/logs/exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_backup_log_task263.json",
    )
    parser.add_argument(
        "--ready-manifest-json",
        default="data/phase1_seed10/logs/exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_ready_manifest_task263.json",
    )
    parser.add_argument(
        "--escalate-manifest-json",
        default="data/phase1_seed10/logs/exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_escalate_manifest_task263.json",
    )
    parser.add_argument(
        "--holding-set-csv",
    ...
    parser.add_argument(
        ...
        default="data/phase1_seed10/logs/holding_recheck_schedule_task262.json",
    )
    parser.add_argument(
        "--previous-week-summary-json",
        default="data/phase1_seed10/logs/exhibitions_text_controlled_operation_week2_run_and_holding_recheck_scheduling_summary_task262.json",
    )
...
def main() -> int:
    ...
    add_stage(
        ...
        (not bool(restore.get("restore_executed", False))) and decision == "CONTROLLED_OPERATION_WEEK3_SUCCESS",
    ...
    holding_recheck_readiness = {
        "artifact": "holding_recheck_readiness_task263",
        "task": "TASK263",
        "run_id": run_id,
        ...
        "recheck_target_bundle_policy": {
            ...
            "execution_note": "readiness check only in TASK263; no holding re-evaluation execution in this run",
        },
    ...
    if decision == "CONTROLLED_OPERATION_WEEK3_SUCCESS":
    ...
    post_run_verification = {
        "artifact": "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_post_run_verification",
        "task": "TASK263",
        "run_id": run_id,
        "created_at": utc_now_iso(),
        "ready_side": {
    ...
    summary = {
        "artifact": "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_summary",
        "task": "TASK263",
        "run_id": run_id,
        "created_at": utc_now_iso(),
        "initial_start": False,
        "weekly_run_phase": "WEEK3",
        ...
        "next_task_recommendation": {
            ...
            "ja": "Continue weekly sync as week4 or prepare holding-lane recheck if trigger becomes due",
        },
    }

    summary_path = output_dir / "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_summary_task263.json"
    post_verification_path = (
        output_dir / "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_post_run_verification_task263.json"
    )
    stage_csv_path = (
        output_dir / "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_runbook_stage_result_task263.csv"
    )
    holding_readiness_json_path = output_dir / "holding_recheck_readiness_task263.json"
    holding_readiness_csv_path = output_dir / "holding_recheck_readiness_task263.csv"
    manifest_path = output_dir / "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_manifest_task263.json"
    ...
    manifest = {
        "artifact": "exhibitions_text_controlled_operation_week3_run_and_holding_recheck_scheduling_manifest",
        "task": "TASK263",
        "run_id": run_id,
        "created_at": utc_now_iso(),
        "decision": decision,
    ...
    report_lines = [
        "# TASK263 Controlled Operation Week3 Run And Holding Recheck Readiness",
        "",
        f"- run_id={run_id}",
        f"- decision={decision}",
        "",
