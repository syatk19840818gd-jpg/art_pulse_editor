...
ARTIFACT_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "retry_run_daily_chain_recovery_chain_retry_run_summary_from_report_rollup_manifest": {
        "artifact_kind": "retry_run_daily_chain_recovery_chain_retry_run_summary_from_report_rollup_manifest",
        "schema_name": "artists_answer_qa_daily_recovery_retry_run_from_rollup_summary",
        "schema_version": "v1",
        "glob_pattern": "artists_answer_qa_daily_recovery_retry_run_from_rollup_summary_*.json",
        "required_prefix": "artists_answer_qa_daily_recovery_retry_run_from_rollup_summary_",
    ...
    "retry_run_daily_chain_recovery_chain_retry_run_summary_from_report_rollup_manifest_report": {
        "artifact_kind": "retry_run_daily_chain_recovery_chain_retry_run_summary_from_report_rollup_manifest_report",
        ...
        "exclude_substrings": ["_report_rollup_"],
    },
    ...
    "retry_run_daily_chain_recovery_chain_report_rollup_retry_manifest": {
        "artifact_kind": "retry_run_daily_chain_recovery_chain_report_rollup_retry_manifest",
        "schema_name": "artists_answer_qa_retry_run_daily_chain_recovery_chain_report_rollup_retry_manifest",
        "schema_version": "v1",
        "glob_pattern": "artists_answer_qa_retry_run_daily_chain_recovery_chain_report_rollup_*_retry_manifest.json",
        "required_prefix": "artists_answer_qa_retry_run_daily_chain_recovery_chain_report_rollup_",
        "required_suffix": "_retry_manifest.json",
        "exclude_substrings": [],
    },
