...
INPUT_ARTIFACT_KIND = "retry_run_daily_chain_report_rollup_retry_manifest"
SOURCE_CLI = "run_aqa_retry_run_daily_chain_retry_run_from_report_rollup_manifest.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run retry-run from daily-chain report-rollup retry manifest. "
